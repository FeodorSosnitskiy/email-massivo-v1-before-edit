  ...
  return (
    <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <a href="https://app.emailmassivo.com/auth/register/" className="group inline-flex items-center space-x-2 px-8 py-4 bg-primary-light hover:bg-primary text-white rounded-lg font-semibold text-lg transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl">
