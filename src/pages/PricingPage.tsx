  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 transition-colors duration-300">
      ...
      <main className="pt-16">
        <section id="pricing" className="pt-20 pb-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-800">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-5xl sm:text-6xl font-bold text-text-darkest dark:text-white mb-4">
                {t.pricing.pageTitle}
              </h1>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-20">
              ...
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-8 rounded-3xl border border-slate-200 dark:border-slate-700 flex flex-col">
                ...
                <div className="mb-6">
                  ...
                  <div className="w-full px-4 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg text-text-darkest dark:text-white">
                    {t.pricing.free.contactsDefault}
                  </div>
                </div>
                <div className="mb-6">
